  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(36, 49, 55, 0.7), rgba(36, 49, 55, 0.7)), url('/images/about-hero.jpg')",
        }}
      />
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-xl md:text-2xl mb-8 font-barlow max-w-3xl mx-auto leading-relaxed  text-white">
    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2
              className="text-section-title mb-6 font-poppins"
              style={{ color: "var(--color-cafenity-dark)" }}
            >
              Cerita Kami Dimulai
            </h2>
            <div
              className="space-y-6 font-barlow text-lg leading-relaxed"
            ...
            >
              ...
              <p>
                Berawal dari sebuah ruang kecil dengan 6 meja, Cafenity kini
                telah berkembang menjadi destinasi favorit para pecinta kopi di
                Jakarta. Kami tidak hanya menyajikan kopi, tetapi menciptakan
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div
                  ...
                  style={{ backgroundColor: "var(--color-garis)" }}
                >
                  <img
...
const MissionVision = () => {
  return (
    <section
      ...
      style={{
        background: "linear-gradient(to bottom, var(--color-latar), white)",
      }}
    >
      <div className="container-custom">
        <motion.div
        ...
        >
          <h2
            className="text-section-title mb-4 font-poppins"
            style={{ color: "var(--color-cafenity-dark)" }}
          >
            Misi & Visi Kami
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h3
                className="text-card-title font-poppins"
                style={{ color: "var(--color-cafenity-dark)" }}
              >
                Misi Kami
              </h3>
  ...
  const milestones = [
    {
      ...
      description:
        "Cafenity pertama dibuka di Jakarta Selatan dengan 6 meja dan visi besar",
        ...
        <div className="relative">
          ...
          {milestones.map((milestone, index) => (
            ...
            >
              ...
              >
                <div
                  className="bg-white rounded-2xl p-6 shadow-custom hover:shadow-custom-lg transition-all duration-300 card-hover"
                ...
                >
                  ...
                  <h3
                    className="text-xl font-bold mb-3 font-poppins"
                    style={{ color: "var(--color-cafenity-dark)" }}
                  >
                    {milestone.title}
                  </h3>
  ...
  const teamMembers = [
    {
      ...
      description:
        "Visioner di balik Cafenity dengan pengalaman 10+ tahun di industri F&B",
      social: {
        linkedin: "#",
        instagram: "#",
      },
    ...
    },
    {
      ...
      description:
        "Kreator strategi pemasaran yang membangun brand awareness Cafenity",
      social: {
        linkedin: "#",
        instagram: "#",
      },
          ...
          {teamMembers.map((member, index) => (
            ...
            >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
                  <div className="flex space-x-3">
                    <a
                      ...
                      className="w-10 h-10 glass rounded-full flex items-center justify-center text-white hover:bg-white/30 transition-colors focus-custom"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
              ...
              <div className="p-6">
                ...
                <p
                  className="text-sm font-barlow leading-relaxed"
                  style={{ color: "var(--color-teks-samping)" }}
                >
                  {member.description}
                </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              {/* Testimonial text */}
              <p
                className="font-barlow mb-6 leading-relaxed"
                style={{ color: "rgba(255, 255, 255, 0.8)" }}
              >
                "{testimonial.text}"
              </p>
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p
            className="text-xl mb-8 font-barlow max-w-2xl mx-auto"
            style={{ color: "rgba(255, 255, 255, 0.9)" }}
          >
